...
image = cv2.imread('miniatura_youtube.png')
...
for channel in channels_response["items"]:
  ...
  snippet["title"] = "New Title of my video with " + str(statistics["viewCount"])+" visits."
  
  cv2.putText(image, "Video with " + str(statistics["viewCount"] + " views." ), (183, 300),
